...
# Соединяем строку "screenshot" с отформатированной датой и расширением .png
name_screenshot = "screenshot" + now_date + ".png"

# Сохраняем скриншот в указанную директорию
driver.save_screenshot("C:\\Users\\Катя\\PycharmProjects\\Selenium_1\\Screen\\" + name_screenshot)